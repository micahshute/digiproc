...
bpsk = Dsp::Strategies::PSK.new(m: 2, modulating_signal: diff_sig, coding_strategy: nil)
bdpsk = Dsp::Strategies::PSK.new(m: 2, modulating_signal: sig)
dpsk = Dsp::Strategies::PSK.new(m: 2, modulating_signal: sig, coding_strategy: Dsp::Strategies::DifferentialEncodingStrategy)
...
plt.plot(data: bpsk.output.digitize, title: "System 1 Xmit Signal", y_label: "Magnitude", dark: true)
plt.plot(data: bdpsk.output.digitize, title: "System 2 Xmit Signal", y_label: "Magnitude", dark: true)
plt.plot(data: dpsk.output.digitize, title: "System 3 Xmit Signal", y_label: "Magnitude", dark: true)
